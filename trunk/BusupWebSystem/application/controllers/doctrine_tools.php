...
use models\entidades\Usuario,
        models\entidades\Endereco,
        models\entidades\Estado,
        models\entidades\Cidade;
        ...
        if ($this->input->post('action')) {
            try {
                ...
                $classes = array(                    
                    ...
                    $this->em->getClassMetadata('models\entidades\EntidadeFinanceira'),
                    $this->em->getClassMetadata('models\entidades\TransacaoFinanceira'),
                    $this->em->getClassMetadata('models\entidades\Unidade'),
                    $this->em->getClassMetadata('models\entidades\Filial'),
                    $this->em->getClassMetadata('models\entidades\Matriz'),
                    $this->em->getClassMetadata('models\entidades\Opcao')
